...
#[OA\Get(
    path: '/cities/{id}/stocks',
    operationId: 'getCityStockList',
    description: 'Returns a paginated list of stocks from selected city.',
    summary: 'List of stocks by city',
    tags: ['Cities'],
    parameters: [
...
interface GetCityStockListDocHandlerInterface
{
